...
import { ChevronsUpDownIcon, PlusIcon, Search } from "lucide-react";
import {
  type ComponentProps,
  createContext,
  type ReactNode,
        ...
        {children ?? (
          <span className="flex w-full items-center justify-between gap-2">
            ...
            {type == "Search" ? (
              ...
              <ChevronsUpDownIcon className="shrink-0" size={16} />
            )}
          </span>
        )}
      </Button>
...
export const ComboboxInput = ({
  ...
  return (
    <CommandInput
      ...
      placeholder={type == "Search" ? "Search..." : `Search ${type}...`}
      value={value}
      {...props}
    />
  );
